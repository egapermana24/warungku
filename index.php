      ...
      <main>
        <div class="container pt-3">
          <div class="col-md-7 mx-auto col-lg-5 offset-lg-4 offset-md-3 text-center hijauTua mt-4 bg-opacity-75 rounded-3 shadow-lg pb-2 pt-2">
            <h1 class="display-6 text-light"><i class="fa-solid fa-store"></i><br> Masuk ke WarungKu</h1>
              ...
              <form action="<?= "prosesLogin.php?aksi=login"; ?>" method="POST">
                <div class="mb-4">
                  <div class="form-floating mb-3">
                    <input name="username" class="form-control form-control-sm" id="username" type="text" placeholder="username" />
                ...
                <button type="submit" class="btn btn-outline-success w-100 my-3 shadow">Login <i class="fa-solid fa-fw fa-right-to-bracket"></i></button>
                <p class="text-center m-0">Belum punya akun? <a href="registrasi.php">Registrasi!</a></p>
              </form>
              <!-- Login Form -->
            </div>
          </div>
